...
<Image 
  ...
  width={800}
  height={600}
  caption="How we envision the SpaceNav-Chrome system working on standard websites such as CNN, incorporating spatial interactions onto more complicated interfaces."
/>
