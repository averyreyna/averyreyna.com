...
<Hero>
  <div>
    <Callout link="" text="ACM DL Page" />
    <Callout link="" text="Paper" />
  </div>
  <div>
...
<Gif src="/help_supporters/help_supporters_interactions.gif" alt="" caption="" />
<Line />
...
**Volunteer Platform**: built with React.js and focuses on two core services: a real-time location matching engine and secure user communications. The matching engine processes user profiles and preferences to create connections, while the frontend implements mobile-first responsive design with accessibility features.
